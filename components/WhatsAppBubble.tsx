    ...
    >
      ...
      <AnimatePresence>
        {hovered && (
          ...
          >
            <span
              className="font-nav text-white px-4 py-2 rounded-xl whitespace-nowrap text-[11px] tracking-widest shadow-xl"
              style={{ background: '#25D366', letterSpacing: '0.1em' }}
            >
              Chat with Hannan
            </span>
            <span
              className="font-nav text-white/70 text-[9px] mt-0.5 pr-1"
